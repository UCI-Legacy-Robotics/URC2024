...
if __name__ == "__main__":
    ...
    # Print calibration chessboard: https://docs.google.com/document/d/1rQ3AZy0SDpwVrDDpD3DV0ex3aigPQI0lMzyPGNGv5ug/edit?usp=sharing
    # Stick onto a flat, stiff surface like a binder or clipboard
